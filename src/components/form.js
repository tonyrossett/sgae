...
export default function Form() {
  ...
  const [buscaDia, setBuscaDia] = useState(""); // busca por dia da semana
  ...
  function handleBusca() {
    const encontrados = registros.filter((item) => {
      ...
      const matchDia = buscaDia
        ? item.dia.toLowerCase() === buscaDia.toLowerCase()
        : true;
      return matchNome && matchDia;
    });
    ...
    <main className="font-sans container mx-auto flex flex-col items-center justify-center px-4 py-8">
      ...
      <div className="mt-6 flex flex-col items-center gap-2">
        ...
        <select
          ...
          className="placeholder-black text-black border border-gray-300 rounded-md px-2 py-2 w-72"
        >
